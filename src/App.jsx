...
import {
  ...
  Headphones, Eye, Waves, RefreshCw, Zap, Move, GraduationCap
} from "lucide-react";
import {
...
const STUDIO_CONFIG = {
  name: "AHAM",
  subtitle: "YOGA",
  tagline: "Your Own Goals Achieved.",
  logoMark: "A",
  description: "Classical Indian yoga in Redmond. 12+ years. Beginner to advanced. Pranayama, restorative, prenatal, seniors. Nestled at the base of Union Hill on 5 acres.",
  heroLine1: "YOUR GOALS",
  heroLine2: "ACHIEVED",
  address: { street: "8226 196th Ave NE", city: "Redmond", state: "WA", zip: "98053" },
  phone: "(425) 202-5071",
  email: "learn@ahamyoga.com",
  neighborhood: "Union Hill, Redmond",
  website: "https://www.ahamyoga.com",
  social: { instagram: "@aham_yoga_studio" },
  locations: [{ name: "Union Hill Studio", type: "yoga" }],
  theme: {
    accent:     { h: 30,  s: 68, l: 46 },
    accentAlt:  { h: 180, s: 35, l: 38 },
    warning:    { h: 10,  s: 55, l: 50 },
    primary:    { h: 25,  s: 20, l: 10 },
    surface:    { h: 30,  s: 15, l: 97 },
    surfaceDim: { h: 28,  s: 12, l: 93 },
  },
  features: {
    ...
    multiLocation: false, beginnerSeries: true, pranayama: true, seniorsYoga: true,
  },
  classCapacity: 20,
...
const STUDIO_IMAGES = {
  home: "https://static.wixstatic.com/media/8eb1bb_86caa9bb23cd4b5a89224637cfc78e20~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_80,usm_0.66_1.00_0.01,enc_auto,quality_auto/8eb1bb_86caa9bb23cd4b5a89224637cfc78e20~mv2.jpg",
  classes: "https://static.wixstatic.com/media/8eb1bb_4882835e05324f2d951a68ab84d5ad35~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_80,usm_0.66_1.00_0.01,enc_auto,quality_auto/Aham%20Yoga%202024_Aham%20Yoga%20Arundhati%20Baitmangalkar%20Redmond_%20Wa%20Lauren%20Mitchell%20Photos-52.jpg",
  schedule: "https://static.wixstatic.com/media/c324be_b38d7f8fde1143e594d21d54ec7c4179~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_80,usm_0.66_1.00_0.01,enc_auto,quality_auto/Aham%20Yoga%202024_Aham%20Yoga%20Arundhati%20Baitmangalkar%20Redmond_%20Wa%20Lauren%20Mitchell%20Photos-227%20(1.jpg",
  practice: "https://static.wixstatic.com/media/8eb1bb_ecb2f4f161db4375bafd90d1aac81839~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_80,usm_0.66_1.00_0.01,enc_auto,quality_auto/Nadi%20Shodhana.jpg",
  community: "https://static.wixstatic.com/media/8eb1bb_7e0d2a9468c14c53a4cd72b07da17061~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_80,usm_0.66_1.00_0.01,enc_auto,quality_auto/Aham%20Yoga%202024_Aham%20Yoga%20Arundhati%20Baitm.jpg",
  teachers: "https://static.wixstatic.com/media/8eb1bb_77c97acbebc1486f952f23ad74e0ac5c~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_80,usm_0.66_1.00_0.01,enc_auto,quality_auto/Aham%20Yoga%202024_Aham%20Yoga%20Arundhati%20Baitmangalkar%20Redmond_%20Wa%20Lauren%20Mitchell%20Photos-65.jpg",
  events: "https://static.wixstatic.com/media/8eb1bb_7a7fc58db61e45da81ea71c829b87a9d~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_80,usm_0.66_1.00_0.01,enc_auto,quality_auto/8eb1bb_7a7fc58db61e45da81ea71c829b87a9d~mv2.jpg",
  membership: "https://static.wixstatic.com/media/8eb1bb_d88ffdd345f747c7bb3569e2de841ead~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_80,usm_0.66_1.00_0.01,enc_auto,quality_auto/8eb1bb_d88ffdd345f747c7bb3569e2de841ead~mv2.jpg",
};
const GRADIENTS = {
  home: `linear-gradient(135deg, hsl(30,68%,28%) 0%, hsl(25,20%,12%) 100%)`,
  classes: `linear-gradient(135deg, hsl(180,35%,24%) 0%, hsl(30,40%,18%) 100%)`,
  schedule: `linear-gradient(135deg, hsl(25,25%,22%) 0%, hsl(30,68%,18%) 100%)`,
  practice: `linear-gradient(135deg, hsl(30,50%,26%) 0%, hsl(25,20%,14%) 100%)`,
  community: `linear-gradient(135deg, hsl(10,55%,28%) 0%, hsl(25,20%,14%) 100%)`,
  teachers: `linear-gradient(135deg, hsl(30,68%,30%) 0%, hsl(180,20%,16%) 100%)`,
  events: `linear-gradient(135deg, hsl(180,35%,26%) 0%, hsl(30,30%,16%) 100%)`,
  membership: `linear-gradient(135deg, hsl(30,68%,24%) 0%, hsl(10,30%,18%) 100%)`,
};
...
const T = {
  ...
  text: "#1e1810", textMuted: "#786448", textFaint: "#a88c68",
  border: "#e4d8c4", borderLight: "#f0e8dc",
};
...
const TEACHERS = [
  { id: "t1", firstName: "Arundhati", lastName: "B.", role: "Owner & Head Teacher", certs: ["E-RYT 500", "Author", "Nationally Recognized"], specialties: ["Classical Yoga", "Pranayama", "Teacher Training", "Advanced Asana"], yearsTeaching: 20, bio: "Recognized as one of the most prominent yoga teachers in the country. Arundhati has been teaching for 20 years and trained thousands of teachers and students. She never forgets to remind you how she started: one student at a time at Aham Yoga.", photo: "" },
  { id: "t2", firstName: "Swaroopa", lastName: "G.", role: "Teacher & Social Media", certs: ["RYT-200", "Pranayama Certified", "Restorative Certified"], specialties: ["Pranayama", "Restorative", "All-Levels Flow"], yearsTeaching: 5, bio: "Swaroopa committed to consistent yoga during the 2020 pandemic and never looked back. She completed the 200-hour, pranayama, and restorative trainings with Aham Yoga. When not teaching, she enjoys nature, hiking, cooking, and designing clothes with her daughter.", photo: "" },
  { id: "t3", firstName: "Srujana", lastName: "M.", role: "Teacher", certs: ["RYT-500", "Prenatal Certified"], specialties: ["Classical Yoga", "Prenatal", "Restorative"], yearsTeaching: 6, bio: "Srujana strives to communicate that yoga needs discipline and regular practice, not a yoga body. Her goal is making every participant feel accomplished. Rooted in classical yoga practices while specializing in prenatal and restorative.", photo: "" },
  { id: "t4", firstName: "Sahana", lastName: "R.", role: "Teacher", certs: ["RYT-200", "Bharatanatyam Dancer"], specialties: ["All-Levels Flow", "Level 2", "Movement"], yearsTeaching: 3, bio: "Sahana grew up in Redmond and loves the PNW. Starting consistent asana practice in 2022, she has a natural gift to teach. Her goal is spreading yoga awareness in a meaningful, adaptable way. Also a Bharatanatyam dancer, art enthusiast, and Program Manager in Tech.", photo: "" },
  { id: "t5", firstName: "Nimisha", lastName: "P.", role: "Teacher", certs: ["RYT-200"], specialties: ["All-Levels Flow", "Level 1", "Beginner Yoga"], yearsTeaching: 5, bio: "Nimisha entered Aham in 2019 wanting flexibility for a dance audition. She fell head over heels for yoga instead. Now a certified teacher, IT Product Manager, and mom of two, she shares her passion and benefits of yoga with others.", photo: "" },
  { id: "t6", firstName: "Michelle", lastName: "K.", role: "Teacher", certs: ["RYT-200", "NASM-CPT", "Professional Educator"], specialties: ["Seniors Yoga", "Level 1", "Fitness Integration"], yearsTeaching: 8, bio: "Michelle is a yoga teacher, professional educator, personal trainer, fitness coach, workshop presenter, and active community leader. Her Seniors Yoga class promotes mobility, stability, and vitality for elder community members.", photo: "" },
];

const TODAYS_FOCUS = {
  id: "focus-today", date: today, name: "All-Levels Flow", type: "ALL_LEVELS", style: "All-Levels", temp: "Non-heated", duration: 60,
  description: "A balanced flow blending strength, flexibility, and mindfulness. Clear options for modifications and advanced variations. Alignment, breath, and awareness. Leave feeling centered, refreshed, and inspired.",
  intention: "Meet yourself where you are. Your own goals, achieved.",
  teacherTip: "This studio is non-heated and nestled in nature at the base of Union Hill. Props are available. Every body is welcome at every level.",
};

const PAST_PRACTICES = [
  { id: "p-y1", date: offsetDate(-1), name: "Pranayama", type: "PRANAYAMA", style: "Pranayama", temp: "Non-heated", duration: 60, description: "The yogic art of breathwork. Modern science is only now catching up with the hidden potential of the breath. Something yogis left us with thousands of years ago.", intention: "The breath holds everything. Learn to listen." },
  { id: "p-y2", date: offsetDate(-2), name: "Level 1 Yoga", type: "LEVEL1", style: "Level 1", temp: "Non-heated", duration: 60, description: "Essential poses, alignment, and mindful movement at a slow to moderate pace. Step-by-step through foundational postures, breathing techniques, and gentle transitions.", intention: "A strong base supports a lifelong practice." },
  { id: "p-y3", date: offsetDate(-3), name: "Restorative", type: "RESTORE", style: "Restorative", temp: "Non-heated", duration: 60, description: "Supported postures with props allowing complete surrender. Release tension at every layer — physical, emotional, energetic. The necessary counterpart to dynamic practice.", intention: "Rest is not the absence of effort. It is its deepest expression." },
];

const UPCOMING_PRACTICE = { id: "p-tmrw", date: offsetDate(1), name: "Level 2 Yoga", type: "LEVEL2", style: "Level 2", temp: "Non-heated", duration: 60, description: "A dynamic full-body practice. Move in rhythm with breath to boost coordination, balance, and mind-body connection. Moderate pace, creative sequencing, and options to safely challenge yourself.", intention: "Wake up from head to toe. Your body already knows. Listen." };

const CLASSES_TODAY = [
  { id: "cl1", time: "09:00", type: "All-Levels Flow", coach: "Arundhati B.", location: "Union Hill Studio", capacity: 20, registered: 18, waitlist: 2 },
  { id: "cl2", time: "10:30", type: "Level 1 Yoga", coach: "Nimisha P.", location: "Union Hill Studio", capacity: 20, registered: 14, waitlist: 0 },
  { id: "cl3", time: "12:00", type: "Pranayama", coach: "Swaroopa G.", location: "Union Hill Studio", capacity: 15, registered: 12, waitlist: 0 },
  { id: "cl4", time: "16:00", type: "Seniors Yoga", coach: "Michelle K.", location: "Union Hill Studio", capacity: 15, registered: 10, waitlist: 0 },
  { id: "cl5", time: "17:30", type: "Level 2 Yoga", coach: "Sahana R.", location: "Union Hill Studio", capacity: 20, registered: 16, waitlist: 0 },
  { id: "cl6", time: "19:00", type: "Restorative", coach: "Srujana M.", location: "Union Hill Studio", capacity: 20, registered: 14, waitlist: 0 },
];

const WEEKLY_SCHEDULE = [
  { day: "Monday", classes: [{ time: "09:00", type: "All-Levels Flow", coach: "Arundhati", location: "Union Hill Studio" }, { time: "10:30", type: "Level 1 Yoga", coach: "Nimisha", location: "Union Hill Studio" }, { time: "12:00", type: "Pranayama", coach: "Swaroopa", location: "Union Hill Studio" }, { time: "16:00", type: "Seniors Yoga", coach: "Michelle", location: "Union Hill Studio" }, { time: "17:30", type: "Level 2 Yoga", coach: "Sahana", location: "Union Hill Studio" }, { time: "19:00", type: "Restorative", coach: "Srujana", location: "Union Hill Studio" }] },
  { day: "Tuesday", classes: [{ time: "09:00", type: "All-Levels Flow", coach: "Arundhati", location: "Union Hill Studio" }, { time: "10:30", type: "Level 1 Yoga", coach: "Nimisha", location: "Union Hill Studio" }, { time: "12:00", type: "Pranayama", coach: "Swaroopa", location: "Union Hill Studio" }, { time: "16:00", type: "Seniors Yoga", coach: "Michelle", location: "Union Hill Studio" }, { time: "17:30", type: "Level 2 Yoga", coach: "Sahana", location: "Union Hill Studio" }, { time: "19:00", type: "Restorative", coach: "Srujana", location: "Union Hill Studio" }] },
  { day: "Wednesday", classes: [{ time: "09:00", type: "All-Levels Flow", coach: "Arundhati", location: "Union Hill Studio" }, { time: "10:30", type: "Level 1 Yoga", coach: "Nimisha", location: "Union Hill Studio" }, { time: "12:00", type: "Pranayama", coach: "Swaroopa", location: "Union Hill Studio" }, { time: "16:00", type: "Seniors Yoga", coach: "Michelle", location: "Union Hill Studio" }, { time: "17:30", type: "Level 2 Yoga", coach: "Sahana", location: "Union Hill Studio" }, { time: "19:00", type: "Restorative", coach: "Srujana", location: "Union Hill Studio" }] },
  { day: "Thursday", classes: [{ time: "09:00", type: "All-Levels Flow", coach: "Arundhati", location: "Union Hill Studio" }, { time: "10:30", type: "Level 1 Yoga", coach: "Nimisha", location: "Union Hill Studio" }, { time: "12:00", type: "Pranayama", coach: "Swaroopa", location: "Union Hill Studio" }, { time: "16:00", type: "Seniors Yoga", coach: "Michelle", location: "Union Hill Studio" }, { time: "17:30", type: "Level 2 Yoga", coach: "Sahana", location: "Union Hill Studio" }, { time: "19:00", type: "Restorative", coach: "Srujana", location: "Union Hill Studio" }] },
  { day: "Friday", classes: [{ time: "09:00", type: "All-Levels Flow", coach: "Arundhati", location: "Union Hill Studio" }, { time: "10:30", type: "Level 1 Yoga", coach: "Nimisha", location: "Union Hill Studio" }, { time: "12:00", type: "Pranayama", coach: "Swaroopa", location: "Union Hill Studio" }, { time: "16:00", type: "Seniors Yoga", coach: "Michelle", location: "Union Hill Studio" }, { time: "17:30", type: "Level 2 Yoga", coach: "Sahana", location: "Union Hill Studio" }, { time: "19:00", type: "Restorative", coach: "Srujana", location: "Union Hill Studio" }] },
  { day: "Saturday", classes: [{ time: "08:00", type: "All-Levels Flow", coach: "Arundhati", location: "Union Hill Studio" }, { time: "09:30", type: "Pranayama", coach: "Swaroopa", location: "Union Hill Studio" }, { time: "11:00", type: "Level 1 Yoga", coach: "Nimisha", location: "Union Hill Studio" }, { time: "11:45", type: "Family Yoga", coach: "Sahana", location: "Union Hill Studio" }] },
  { day: "Sunday", classes: [{ time: "08:00", type: "All-Levels Flow", coach: "Arundhati", location: "Union Hill Studio" }, { time: "09:30", type: "Restorative", coach: "Srujana", location: "Union Hill Studio" }, { time: "16:00", type: "Seniors Yoga", coach: "Michelle", location: "Union Hill Studio" }] },
];

const COMMUNITY_FEED = [
  { id: "cf1", user: "Priya S.", milestone: "Beginner Series Complete", message: "Six weeks with Nimisha and I went from not touching my toes to holding tree pose with confidence. Aham is where beginners belong.", date: today, celebrations: 24 },
  { id: "cf2", user: "David L.", milestone: "100 Classes", message: "One hundred classes with Arundhati and team. Her attention to detail and alignment changed everything about how I move.", date: today, celebrations: 30 },
  { id: "cf3", user: "Margaret K.", milestone: "Seniors Yoga Regular", message: "Michelle makes yoga accessible at any age. At 72, I am more mobile than I was at 62. This class is a gift.", date: offsetDate(-1), celebrations: 36 },
  { id: "cf4", user: "Ravi T.", milestone: "First Pranayama", message: "Swaroopa guided us through breathwork I did not know existed. Twenty minutes of pranayama and my entire nervous system reset.", date: offsetDate(-2), celebrations: 20 },
];

const MILESTONE_BADGES = {
  "First Class": { icon: Leaf, color: T.accent },
  "Beginner Series": { icon: GraduationCap, color: T.accent },
  ...
  "First Pranayama": { icon: Waves, color: "#8b5cf6" },
  "1 Year Member": { icon: Award, color: T.success },
};

const EVENTS = [
  { id: "ev1", name: "200HR Yoga Teacher Training", date: "2026-09-06", startTime: "09:00", type: "Training", description: "Led by Arundhati. Classical Indian yoga tradition with modern application. Alignment, breathwork, philosophy, and the art of teaching. Aham has trained thousands.", fee: 3500, maxParticipants: 15, registered: 8, status: "Registration Open" },
  { id: "ev2", name: "6-Week Beginner Series", date: "2026-05-05", startTime: "10:30", type: "Series", description: "Top-rated beginner program in the area. Build confidence, improve flexibility, feel at ease on your mat. No experience required. Just sign up and we will take care of the rest.", fee: 149, maxParticipants: 12, registered: 8, status: "Registration Open" },
  { id: "ev3", name: "Family Yoga Launch", date: offsetDate(5), startTime: "11:45", type: "Family", description: "New Saturday offering. Movement, play, and mindfulness for the whole family. Building connection through practice together.", fee: 25, maxParticipants: 15, registered: 10, status: "Open" },
];

const MEMBERSHIP_TIERS = [
  { id: "m0", name: "New Student Intro", type: "intro", price: 49, period: "30 days", features: ["Unlimited classes for 30 days", "All class types", "In-studio and online", "New students only"], popular: false },
  { id: "m1", name: "Drop-In", type: "drop-in", price: 25, period: "per class", features: ["Single class credit", "Any class type", "In-studio or online"], popular: false },
  { id: "m2", name: "5 Class Pass", type: "pack", price: 115, period: "5 classes", features: ["$23 per class", "Any class type", "In-studio or online", "30-day expiration"], popular: false },
  { id: "m3", name: "All-Access Monthly", type: "unlimited", price: 135, period: "/month", features: ["Unlimited in-studio + online", "All class types", "2 free guest passes", "Auto-renewing", "Holds available (2 weeks-3 months)"], popular: true },
  { id: "m4", name: "6-Week Beginner Series", type: "series", price: 149, period: "6 weeks", features: ["Complete foundational program", "No experience needed", "Step-by-step instruction", "Props and personal guidance", "Top-rated beginner program"], popular: false },
];

const ANNOUNCEMENTS = [
  { id: "a1", title: "6-Week Beginner Series Enrolling Now", message: "Top-rated program in the area. Build confidence and foundation for lifelong practice. No experience required.", type: "celebration", pinned: true },
  { id: "a2", title: "Family Yoga: Saturdays at 11:45 AM", message: "New offering. Movement, play, and mindfulness for the whole family. Launching this week.", type: "info", pinned: false },
];

const MEMBERS_DATA = [
  { id: "mem1", name: "Priya Sharma", email: "priya@email.com", membership: "All-Access Monthly", status: "active", joined: "2024-03-01", checkIns: 198, lastVisit: today },
  { id: "mem2", name: "David Lee", email: "david@email.com", membership: "All-Access Monthly", status: "active", joined: "2023-06-15", checkIns: 286, lastVisit: offsetDate(-1) },
  { id: "mem3", name: "Margaret Kim", email: "margaret@email.com", membership: "5 Class Pass", status: "active", joined: "2025-12-01", checkIns: 14, lastVisit: offsetDate(-3) },
  { id: "mem4", name: "Ravi Tandon", email: "ravi@email.com", membership: "All-Access Monthly", status: "active", joined: "2025-01-10", checkIns: 86, lastVisit: today },
  { id: "mem5", name: "Chen Wei", email: "chen@email.com", membership: "6-Week Beginner", status: "active", joined: "2026-03-24", checkIns: 4, lastVisit: offsetDate(-4) },
  { id: "mem6", name: "Sarah Park", email: "sarah@email.com", membership: "New Student Intro", status: "active", joined: "2026-04-08", checkIns: 3, lastVisit: offsetDate(-1) },
];

const ADMIN_METRICS = { activeMembers: 142, memberChange: 7, todayCheckIns: 38, weekCheckIns: 228, monthlyRevenue: 19800, revenueChange: 8.4, renewalRate: 90.2, workshopRevenue: 4800 };

const ADMIN_CHARTS = {
  attendance: [
    { day: "Mon", total: 38, avg: 6 }, { day: "Tue", total: 34, avg: 6 },
    { day: "Wed", total: 32, avg: 5 }, { day: "Thu", total: 36, avg: 6 },
    { day: "Fri", total: 30, avg: 5 }, { day: "Sat", total: 36, avg: 9 },
    { day: "Sun", total: 22, avg: 7 },
  ],
  revenue: [
    { month: "Sep", revenue: 15400 }, { month: "Oct", revenue: 16200 },
    { month: "Nov", revenue: 17000 }, { month: "Dec", revenue: 15800 },
    { month: "Jan", revenue: 18200 }, { month: "Feb", revenue: 19000 },
    { month: "Mar", revenue: 19800 },
  ],
  classPopularity: [
    { name: "9:00 AM", pct: 92 }, { name: "10:30 AM", pct: 72 },
    { name: "12:00 PM", pct: 80 }, { name: "4:00 PM", pct: 68 },
    { name: "5:30 PM", pct: 82 }, { name: "7:00 PM", pct: 72 },
  ],
  membershipBreakdown: [
    { name: "All-Access Monthly", value: 58, color: T.accent },
    { name: "5 Class Pass", value: 28, color: T.success },
    { name: "Beginner Series", value: 22, color: T.warning },
...
function TeacherAvatar({ teacher, size = 56 }) {
  ...
  return (
    <div style={{ width: size, height: size, borderRadius: size > 48 ? 14 : 10, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Vollkorn', serif", fontSize: size * 0.38, color: "#fff", flexShrink: 0, fontWeight: 600 }}>
...
function SectionHeader({ title, linkText, linkPage }) {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, padding: "0 16px" }}>
      <h2 style={{ fontFamily: "'Vollkorn', serif", fontSize: 24, margin: 0, fontWeight: 600 }}>{title}</h2>
...
function PracticeCard({ practice, variant, expanded, onToggle }) {
  ...
  const typeColors = { ALL_LEVELS: T.accent, LEVEL1: T.success, LEVEL2: "#3b82f6", PRANAYAMA: "#8b5cf6", RESTORE: T.warning, RESTORATIVE: T.success, SENIORS: T.success, FAMILY: T.accent, SPECIAL: T.success };
  return (
    <div onClick={onToggle} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderLeft: `4px solid ${typeColors[practice.type] || T.accent}`, borderRadius: 12, padding: isFeatured ? "18px 18px" : "14px 16px", cursor: onToggle ? "pointer" : "default" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: isExpanded ? 10 : 0 }}>
        <div>
          ...
          <h3 style={{ fontFamily: "'Vollkorn', serif", fontSize: isFeatured ? 26 : 20, margin: 0, color: T.text, fontWeight: 600 }}>{practice.name}</h3>
        </div>
...
function StatBox({ label, value }) {
  return (
    <div style={{ background: T.bgDim, borderRadius: 8, padding: "10px 12px", textAlign: "center" }}>
      ...
      <p style={{ fontFamily: "'Vollkorn', serif", fontSize: 22, color: T.text, margin: 0, fontWeight: 700 }}>{value}</p>
    </div>
  );
}
...
function AdminCard({ title, children }) {
  return (
    <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
      <h3 style={{ fontFamily: "'Vollkorn', serif", fontSize: 18, color: "#1a1a1a", margin: "0 0 14px", fontWeight: 600 }}>{title}</h3>
      {children}
    </div>
  );
}
    ...
    <div>
            ...
            return (
              <div key={c.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12 }}>
                <div style={{ textAlign: "center", minWidth: 48 }}>
                  <span style={{ fontFamily: "'Vollkorn', serif", fontSize: 22, color: T.text, fontWeight: 600 }}>{fmtTime(c.time).split(":")[0]}</span>
      ...
      {ANNOUNCEMENTS.length > 0 && (
        <section style={{ marginTop: 28, padding: "0 16px" }}>
          <h2 style={{ fontFamily: "'Vollkorn', serif", fontSize: 24, margin: "0 0 12px", fontWeight: 600 }}>Announcements</h2>
      ...
      <section style={{ padding: "16px 16px 8px", marginTop: 20 }}>
        <div style={{ background: `linear-gradient(165deg, ${T.bg}, hsl(30,20%,14%))`, borderRadius: 16, padding: "24px 20px", color: "#fff", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative" }}>
            <h3 style={{ fontFamily: "'Vollkorn', serif", fontSize: 24, margin: "0 0 6px", fontWeight: 600 }}>New to Aham?</h3>
            <p style={{ fontSize: 13, color: "#b8a898", margin: "0 0 16px", lineHeight: 1.5 }}>New student intro: 30 days unlimited for $49. In-studio and online.</p>
            <button onClick={() => {}} style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "10px 20px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontFamily: "'Vollkorn', serif", fontSize: 15, cursor: "pointer", fontWeight: 600 }}>View Memberships <ChevronRight size={16} /></button>
          </div>
        </div>
      </section>
    </div>
...
function ClassesPage() {
  ...
  return (
    <div>
      <PageHero image={STUDIO_IMAGES.classes || GRADIENTS.classes} title="Classes" subtitle="All-levels, pranayama, restorative, level 1 & 2, seniors, and more" />
      ...
      <div style={{ padding: "20px 16px 0" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {WEEKLY_SCHEDULE[selectedDay]?.classes.map((cls, i) => {
            const isSpecial = cls.type.includes("Pranayama") || cls.type.includes("Seniors") || cls.type.includes("Family") || cls.type.includes("Beginner");
            return (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12 }}>
                <div style={{ textAlign: "center", minWidth: 54 }}>
                  <span style={{ fontFamily: "'Vollkorn', serif", fontSize: 16, color: T.text, fontWeight: 600 }}>{fmtTime(cls.time)}</span>
                </div>
                <div style={{ flex: 1 }}>
    ...
    <div>
      ...
      <div style={{ padding: "20px 16px 0" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 20 }}>
          {[
            ...
            <div key={i} style={{ background: s.ghost, border: `1px solid ${s.bdr}`, borderRadius: 12, padding: "14px 10px", textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "'Vollkorn', serif", fontSize: 28, fontWeight: 700, color: T.text }}>{s.val}</div>
        ...
        {activeTab === "log" && (
          <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12, padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <button onClick={() => { setSaved(true); setTimeout(() => setSaved(null), 2000); setReflection({ energy: 4, focus: 4, notes: "" }); }} style={{ padding: "12px 0", borderRadius: 8, border: "none", fontWeight: 700, cursor: "pointer", background: T.accent, color: "#fff", fontFamily: "'Vollkorn', serif", fontSize: 17 }}>
        ...
        <div style={{ marginTop: 24 }}>
          <h3 style={{ fontFamily: "'Vollkorn', serif", fontSize: 22, margin: "0 0 12px", fontWeight: 600 }}>Recent Practice</h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              { date: today, name: "All-Levels Flow", result: "60 min", badge: "flow", icon: Sun, color: T.warning, ghost: T.warningGhost },
              { date: offsetDate(-1), name: "Pranayama", result: "60 min", badge: "breath", icon: Wind, color: "#8b5cf6", ghost: "#8b5cf610" },
      ...
      <div style={{ padding: "20px 16px 0" }}>
        {STUDIO_CONFIG.features.guestPasses && (
          <div style={{ background: `linear-gradient(135deg, ${T.bg}, hsl(30,20%,14%))`, borderRadius: 14, padding: "18px", marginBottom: 20, color: "#fff" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}><Gift size={20} color={T.accent} /><h3 style={{ fontFamily: "'Vollkorn', serif", fontSize: 18, margin: 0, fontWeight: 600 }}>Guest Passes</h3></div>
            ...
            return (
              <div key={item.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, padding: "16px 18px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  <div style={{ width: 40, height: 40, borderRadius: "50%", background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Vollkorn', serif", fontSize: 16, color: "#fff", fontWeight: 700, flexShrink: 0 }}>{item.user[0]}</div>
...
function TeachersPage() {
  ...
  return (
    <div>
      <PageHero image={STUDIO_IMAGES.teachers || GRADIENTS.teachers} title="Teachers" subtitle="Classical Indian yoga led by nationally recognized Arundhati" />
      <div style={{ padding: "20px 16px 0", display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div style={{ padding: "20px 16px 0", display: "flex", flexDirection: "column", gap: 12 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: T.bgCard, border: `1px solid ${tier.popular ? T.accent : T.border}`, borderRadius: 14, padding: "20px 18px", position: "relative", overflow: "hidden" }}>
            ...
            <h3 style={{ fontFamily: "'Vollkorn', serif", fontSize: 22, margin: "0 0 4px", color: T.text, fontWeight: 600 }}>{tier.name}</h3>
            <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 12 }}>
              <span style={{ fontFamily: "'Vollkorn', serif", fontSize: 38, color: T.accent, fontWeight: 700 }}>${tier.price}</span>
            ...
            <button style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "'Vollkorn', serif", background: tier.popular ? T.accent : T.bg, color: "#fff" }}>Get Started</button>
          </div>
        ))}
      </div>
    </div>
...
function EventsPage() {
  return (
    <div>
      <PageHero image={STUDIO_IMAGES.events || GRADIENTS.events} title="Events" subtitle="Workshops, teacher training, and special offerings" />
      <div style={{ padding: "20px 16px 0" }}>
        {EVENTS.map(ev => (
          <div key={ev.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, overflow: "hidden", marginBottom: 16 }}>
            <div style={{ background: `linear-gradient(135deg, ${T.bg}, hsl(30,20%,14%))`, padding: "20px 18px", color: "#fff" }}>
              ...
              <h3 style={{ fontFamily: "'Vollkorn', serif", fontSize: 20, margin: "6px 0 4px", fontWeight: 600 }}>{ev.name}</h3>
            ...
            <div style={{ padding: "16px 18px" }}>
              ...
              <button style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "'Vollkorn', serif", background: T.accent, color: "#fff" }}>Register Now</button>
            </div>
          </div>
        ))}
      </div>
...
function AdminDashboard() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div><h1 style={{ fontFamily: "'Vollkorn', serif", fontSize: 28, color: "#1a1a1a", margin: 0, fontWeight: 600 }}>Dashboard</h1><p style={{ fontSize: 13, color: "#6b7280", margin: "4px 0 0" }}>Welcome back. Here is what is happening at Aham.</p></div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 14 }}>
        {metrics.map((m, i) => (
          <div key={i} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
            ...
            <div style={{ fontFamily: "'Vollkorn', serif", fontSize: 30, color: "#1a1a1a", fontWeight: 700 }}>{m.value}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 14 }}>
        <AdminCard title="Weekly Attendance"><div style={{ height: 220 }}><ResponsiveContainer width="100%" height="100%"><BarChart data={ADMIN_CHARTS.attendance}><CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" /><XAxis dataKey="day" stroke="#6b7280" fontSize={12} /><YAxis stroke="#6b7280" fontSize={12} /><Tooltip contentStyle={{ backgroundColor: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a1a" }} /><Bar dataKey="total" fill={T.accent} radius={[4, 4, 0, 0]} /></BarChart></ResponsiveContainer></div></AdminCard>
        <AdminCard title="Revenue Trend"><div style={{ height: 220 }}><ResponsiveContainer width="100%" height="100%"><AreaChart data={ADMIN_CHARTS.revenue}><CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" /><XAxis dataKey="month" stroke="#6b7280" fontSize={12} /><YAxis stroke="#6b7280" fontSize={12} tickFormatter={v => `$${v / 1000}k`} /><Tooltip contentStyle={{ backgroundColor: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a1a" }} formatter={(v) => [`$${v.toLocaleString()}`, "Revenue"]} /><defs><linearGradient id="revGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor={T.accent} stopOpacity={0.3} /><stop offset="100%" stopColor={T.accent} stopOpacity={0} /></linearGradient></defs><Area type="monotone" dataKey="revenue" stroke={T.accent} fill="url(#revGrad)" /></AreaChart></ResponsiveContainer></div></AdminCard>
      </div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 14 }}>
        <AdminCard title="Membership Breakdown">
          <div style={{ height: 200, display: "flex", alignItems: "center", justifyContent: "center" }}><ResponsiveContainer width="100%" height="100%"><PieChart><Pie data={ADMIN_CHARTS.membershipBreakdown} cx="50%" cy="50%" innerRadius={50} outerRadius={80} dataKey="value" paddingAngle={4}>{ADMIN_CHARTS.membershipBreakdown.map((e, i) => <Cell key={i} fill={e.color} />)}</Pie><Tooltip contentStyle={{ backgroundColor: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a1a" }} /></PieChart></ResponsiveContainer></div>
        ...
        <AdminCard title="Class Popularity (% Capacity)"><div style={{ height: 210 }}><ResponsiveContainer width="100%" height="100%"><BarChart data={ADMIN_CHARTS.classPopularity} layout="vertical"><CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" horizontal={false} /><XAxis type="number" stroke="#6b7280" fontSize={12} domain={[0, 100]} /><YAxis type="category" dataKey="name" stroke="#6b7280" fontSize={11} width={60} /><Tooltip contentStyle={{ backgroundColor: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a1a" }} formatter={v => [`${v}%`, "Capacity"]} /><Bar dataKey="pct" fill={T.accent} radius={[0, 4, 4, 0]} /></BarChart></ResponsiveContainer></div></AdminCard>
        <AdminCard title="Recent Activity">
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {[{ text: "New member signup", detail: "Sarah Park - New Student Intro", time: "5 min ago", color: T.accent },{ text: "Workshop registration", detail: "Beginner Series - Chen W.", time: "12 min ago", color: "#8b5cf6" },{ text: "Class waitlist full", detail: "5:30 PM Level 2 Yoga", time: "18 min ago", color: T.success },{ text: "Payment received", detail: "All-Access Monthly - Priya Sharma", time: "25 min ago", color: T.warning },{ text: "Guest pass redeemed", detail: "Priya Sharma's guest", time: "1 hr ago", color: "#3b82f6" }].map((a, i) => (
...
function AdminMembersPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Vollkorn', serif", fontSize: 28, color: "#1a1a1a", margin: 0, fontWeight: 600 }}>Members</h1><CrudBar addLabel="Add Member" /></div>
      <div style={{ display: "flex", gap: 10 }}>
        <div style={{ flex: 1, position: "relative" }}><Search size={16} style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: "#9ca3af" }} /><input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search members..." style={{ width: "100%", padding: "10px 12px 10px 36px", background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a1a", fontSize: 13, outline: "none", boxSizing: "border-box" }} /></div>
        <div style={{ display: "flex", gap: 4 }}>{["all", "active", "frozen"].map(f => <button key={f} onClick={() => setFilter(f)} style={{ padding: "8px 14px", borderRadius: 8, border: "none", fontSize: 12, fontWeight: 600, cursor: "pointer", textTransform: "capitalize", background: filter === f ? T.accent : "#fff", color: filter === f ? "#fff" : "#6b7280" }}>{f}</button>)}</div>
      </div>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          ...
          <tbody>{filtered.map(m => (
            <tr key={m.id} style={{ borderBottom: "1px solid #f3f4f6" }}>
              <td style={{ padding: "12px 16px" }}><p style={{ color: "#1a1a1a", fontWeight: 600, margin: 0 }}>{m.name}</p><p style={{ color: "#9ca3af", fontSize: 12, margin: "2px 0 0" }}>{m.email}</p></td>
...
function AdminSchedulePage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Vollkorn', serif", fontSize: 28, color: "#1a1a1a", margin: 0, fontWeight: 600 }}>Schedule</h1><CrudBar addLabel="Add Class" /></div>
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, overflow: "hidden" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          ...
          <tbody>{CLASSES_TODAY.map(c => (
            <tr key={c.id} style={{ borderBottom: "1px solid #f3f4f6" }}>
              <td style={{ padding: "12px 14px", color: "#1a1a1a", fontFamily: "monospace" }}>{fmtTime(c.time)}</td>
...
function AdminTeachersPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Vollkorn', serif", fontSize: 28, color: "#1a1a1a", margin: 0, fontWeight: 600 }}>Teachers</h1><CrudBar addLabel="Add Teacher" /></div>
        ...
        {TEACHERS.map(t => (
          <div key={t.id} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
              ...
              <div><h3 style={{ fontSize: 15, fontWeight: 700, color: "#1a1a1a", margin: 0 }}>{t.firstName} {t.lastName}</h3><p style={{ fontSize: 12, color: T.accent, fontWeight: 600, margin: "2px 0 0" }}>{t.role}</p></div>
            </div>
...
function AdminEventsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Vollkorn', serif", fontSize: 28, color: "#1a1a1a", margin: 0, fontWeight: 600 }}>Events & Workshops</h1><CrudBar addLabel="New Event" /></div>
      {EVENTS.map(ev => (
        <div key={ev.id} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div>
              ...
              <h3 style={{ fontSize: 18, fontWeight: 700, color: "#1a1a1a", margin: "8px 0 4px" }}>{ev.name}</h3>
              <p style={{ fontSize: 13, color: "#6b7280" }}>{formatDateShort(ev.date)} — {ev.type} — ${ev.fee}</p>
            </div>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
              <div style={{ textAlign: "right" }}><div style={{ fontFamily: "'Vollkorn', serif", fontSize: 28, color: T.accent, fontWeight: 700 }}>{ev.registered}</div><p style={{ fontSize: 11, color: "#6b7280" }}>of {ev.maxParticipants}</p></div>
              <CrudActions />
            </div>
          </div>
        </div>
...
function AdminPricingPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Vollkorn', serif", fontSize: 28, color: "#1a1a1a", margin: 0, fontWeight: 600 }}>Pricing & Memberships</h1><CrudBar addLabel="Add Tier" /></div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: "#fff", border: `1px solid ${tier.popular ? T.accent : "#e5e7eb"}`, borderRadius: 12, padding: 18 }}>
            ...
            <h3 style={{ fontFamily: "'Vollkorn', serif", fontSize: 20, color: "#1a1a1a", margin: "0 0 4px", fontWeight: 600 }}>{tier.name}</h3>
            <div style={{ fontFamily: "'Vollkorn', serif", fontSize: 32, color: T.accent, fontWeight: 700 }}>${tier.price}<span style={{ fontSize: 14, color: "#6b7280", fontWeight: 400 }}> {tier.period}</span></div>
...
function AdminBroadcastPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Vollkorn', serif", fontSize: 28, color: "#1a1a1a", margin: 0, fontWeight: 600 }}>Broadcast</h1>
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
        <h3 style={{ color: "#1a1a1a", fontSize: 16, fontWeight: 700, margin: "0 0 12px" }}>New Broadcast</h3>
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <input placeholder="Title" style={{ padding: "10px 14px", background: "#f9fafb", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a1a", fontSize: 13, outline: "none" }} />
          <textarea value={message} onChange={e => setMessage(e.target.value)} placeholder="Message..." rows={4} style={{ padding: "10px 14px", background: "#f9fafb", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a1a", fontSize: 13, outline: "none", resize: "vertical", fontFamily: "inherit" }} />
      ...
      <div><h3 style={{ color: "#1a1a1a", fontSize: 16, fontWeight: 700, margin: "0 0 12px" }}>Sent</h3>{ANNOUNCEMENTS.map(a => <div key={a.id} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, padding: 14, marginBottom: 8 }}><div style={{ display: "flex", justifyContent: "space-between" }}><h4 style={{ color: "#1a1a1a", margin: 0, fontSize: 14, fontWeight: 600 }}>{a.title}</h4><CrudActions /></div><p style={{ fontSize: 12, color: "#6b7280", margin: "4px 0 0" }}>{a.message}</p></div>)}</div>
    </div>
  );
}
...
function AdminSettingsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Vollkorn', serif", fontSize: 28, color: "#1a1a1a", margin: 0, fontWeight: 600 }}>Studio Settings</h1>
        ...
        {!confirmed ? (
          <>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'Vollkorn', serif", fontSize: 24, margin: 0, color: T.text, fontWeight: 600 }}>Confirm Reservation</h2>
            ...
            <div style={{ background: T.bgDim, borderRadius: 14, padding: "18px 16px", marginBottom: 20 }}>
              ...
              <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}><MapPin size={16} color={T.textMuted} /><span style={{ fontSize: 14, color: T.text }}>8226 196th Ave NE, Union Hill, Redmond</span></div>
              </div>
            </div>
            <div style={{ background: T.accentGhost, border: `1px solid ${T.accentBorder}`, borderRadius: 10, padding: "12px 14px", marginBottom: 20 }}>
              ...
              <p style={{ fontSize: 12, color: "#5a5040", margin: "0 0 4px", lineHeight: 1.4 }}>Cancel via email 7 days before billing. Holds available 2 weeks-3 months.. Cancel via email admin@ahamyoga.com to avoid fees.</p>
              <p style={{ fontSize: 12, color: "#5a5040", margin: 0, lineHeight: 1.4 }}>Non-heated studio on 5 acres at base of Union Hill. Mirrors. Easy parking..</p>
            </div>
            <button onClick={() => { setConfirmed(true); onConfirm(classData.id); }} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontSize: 17, fontWeight: 700, cursor: "pointer", fontFamily: "'Vollkorn', serif", background: isFull ? T.success : T.accent, color: "#fff", marginBottom: 8 }}>{isFull ? "Join Waitlist" : "Confirm Reservation"}</button>
          ...
          <div style={{ textAlign: "center", padding: "10px 0" }}>
            ...
            <h2 style={{ fontFamily: "'Vollkorn', serif", fontSize: 24, margin: "0 0 4px", color: T.text, fontWeight: 600 }}>{isFull ? "Added to Waitlist" : "You're In!"}</h2>
            ...
            <button onClick={onClose} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontSize: 17, fontWeight: 700, cursor: "pointer", fontFamily: "'Vollkorn', serif", background: T.accent, color: "#fff" }}>Done</button>
          </div>
        )}
      </div>
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: T.bgCard, borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 390, maxHeight: "85vh", overflow: "auto", padding: "20px 20px 40px" }}>
        ...
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 48, height: 48, borderRadius: 12, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Vollkorn', serif", fontSize: 20, color: "#fff", fontWeight: 700 }}>PS</div>
            <div><p style={{ fontWeight: 700, margin: 0, fontSize: 15 }}>Priya Sharma</p><p style={{ fontSize: 12, color: T.textMuted, margin: "2px 0 0" }}>All-Access Monthly — Since Mar 2024</p></div>
          </div>
        </div>
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
...
function NotificationsModal({ onClose }) {
  const notifications = [
    { id: 1, title: "Tomorrow: Level 2 Yoga", message: "Dynamic full-body practice. Creative sequencing. Non-heated.", type: "class", time: "2 hours ago", read: false },
    { id: 2, title: "New Milestone!", message: "David L. reached 100 classes. Celebrate together!", type: "community", time: "4 hours ago", read: false },
    { id: 3, title: "Class Reminder", message: "Reserved for 5:30 PM Level 2 Yoga with Sahana.", type: "class", time: "6 hours ago", read: true },
    { id: 4, title: "6-Week Beginner Series", message: "Top-rated beginner program. No experience needed. Enrolling now.", type: "event", time: "1 day ago", read: true },
  ];
  return (
    <div onClick={onClose} style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 100, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
...
// ═══════════════════════════════════════════════════════════════
//  FULL-SCREEN ADMIN (renders outside phone frame)
// ═══════════════════════════════════════════════════════════════
export function AdminPanel({ onExit }) {
  ...
  return (
    <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
      <div style={{ display: "flex", width: "100vw", height: "100vh", fontFamily: "'Barlow', system-ui, sans-serif", background: "#f5f5f5" }}>
        <aside style={{ width: 240, background: "#fff", borderRight: "1px solid #e5e7eb", display: "flex", flexDirection: "column", flexShrink: 0 }}>
          <div style={{ padding: "16px 14px", borderBottom: "1px solid #e5e7eb" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ width: 32, height: 32, borderRadius: 8, background: T.accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Vollkorn', serif", fontSize: 14, color: "#fff", fontWeight: 700 }}>{STUDIO_CONFIG.logoMark}</div>
              <div><span style={{ fontFamily: "'Vollkorn', serif", fontSize: 16, display: "block", lineHeight: 1, fontWeight: 600, color: "#1a1a1a" }}>{STUDIO_CONFIG.name}</span><span style={{ fontSize: 8, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.15em" }}>Admin</span></div>
            </div>
          </div>
          ...
          <div style={{ borderTop: "1px solid #e5e7eb", padding: "8px 6px" }}>
            <button onClick={onExit} style={{ display: "flex", alignItems: "center", gap: 8, width: "100%", padding: "8px 10px", borderRadius: 8, border: "none", background: "transparent", color: "#6b7280", fontSize: 13, cursor: "pointer", textAlign: "left" }}><LogOut size={16} /><span>Exit Admin</span></button>
          </div>
        </aside>
        <main style={{ flex: 1, padding: 24, overflow: "auto", background: "#f9fafb" }}>{renderPage()}</main>
      </div>
    </AppContext.Provider>
  );
}
...
// ═══════════════════════════════════════════════════════════════
//  MAIN APP (consumer phone view)
// ═══════════════════════════════════════════════════════════════
export default function App({ onAdminToggle }) {
        ...
        <header style={{ position: "absolute", top: 0, left: 0, right: 0, background: T.bg, color: "#fff", padding: "10px 14px", display: "flex", alignItems: "center", justifyContent: "space-between", zIndex: 30 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{ fontFamily: "'Vollkorn', serif", fontSize: 18, lineHeight: 1, fontWeight: 600 }}>{STUDIO_CONFIG.name}</span>
              <span style={{ fontSize: 8, color: "#71717a", textTransform: "uppercase", letterSpacing: "0.15em" }}>{STUDIO_CONFIG.subtitle}</span>
            </div>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 2 }}>
            <button onClick={onAdminToggle} style={{ padding: 8, borderRadius: 8, border: "none", background: "transparent", cursor: "pointer", color: T.accent }}><Shield size={20} /></button>
        ...
        {showMore && (
          <div onClick={() => setShowMore(false)} style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 40 }}>
            <div onClick={e => e.stopPropagation()} style={{ position: "absolute", bottom: 68, left: 16, right: 16, background: T.bgCard, borderRadius: 16, padding: "14px 12px", boxShadow: "0 8px 32px rgba(0,0,0,.15)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 6px 8px" }}><span style={{ fontFamily: "'Vollkorn', serif", fontSize: 20, fontWeight: 600 }}>More</span><button onClick={() => setShowMore(false)} style={{ padding: 4, borderRadius: 6, border: "none", background: "transparent", cursor: "pointer" }}><X size={18} color={T.textMuted} /></button></div>
